 ...
 * @author adolf
 */
public class CurrencyConverterNotUse extends javax.swing.JFrame {
     ...
     */
    public CurrencyConverterNotUse() {
        initComponents();
    ...
    private void jButtonRunCurrencyConverterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRunCurrencyConverterActionPerformed
        ...
        if (actualCurrency.equals("Mexican Peso")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CurrencyConverterNotUse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CurrencyConverterNotUse().setVisible(true);
            }
        });
    }
